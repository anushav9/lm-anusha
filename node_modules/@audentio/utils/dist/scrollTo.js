...
function scrollTo(to) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        targetNode = _ref$targetNode === undefined ? window : _ref$targetNode,
        _ref$easing = _ref.easing,
        easing = _ref$easing === undefined ? _easings.easeInOutQuad : _ref$easing;

    var initialY = targetNode.scrollY;
    var initialX = targetNode.scrollX;

    if (duration) {
        var diff = to - initialY;
        var increment = 20;
        var currentTime = 0;
        ...
        var animateScroll = function animateScroll() {
            ...
            var newScrollTop = easing(currentTime, initialY, diff, duration);
